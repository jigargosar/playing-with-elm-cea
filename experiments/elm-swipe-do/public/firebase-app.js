!(function(t, e) {
  ...
  var f = c(function(t) {
    ...
    g = function(t, e) {
      if (!l(t)) return t
      var r, n
      if (e && 'function' == typeof (r = t.toString) && !l((n = r.call(t))))
        return n
    ...
    x = c(function(t) {
      ...
      ;(h.inspectSource = function(t) {
        ...
        (t.exports = function(t, r, o, i) {
          ...
          s && (j(o, 'name') || E(o, 'name', r)),
            t[r] !== o &&
              (s && (j(o, e) || E(o, e, t[r] ? '' + t[r] : n.join(String(r)))),
              t === f
                ? (t[r] = o)
                : i
                  ? t[r]
        ...
        return (
          H(t) &&
            ('function' != typeof (e = t.constructor) ||
              (e !== Array && !H(e.prototype)) ||
              (e = void 0),
            l(e) && null === (e = e[$]) && (e = void 0)),
          void 0 === e ? Array : e
        )
      })(t))(e)
    },
  ...
  var ot,
    ...
    function(t, e, r) {
      ...
      if (ot && e != e) {
        for (; i > s; ) if ((n = o[s++]) != n) return !0
      } else
        for (; i > s; s++) if ((ot || s in o) && o[s] === e) return ot || s || 0
      return !ot && -1
    }),
    ht = ct('IE_PROTO'),
    lt = function(t, e) {
    ...
    mt =
      ...
      d(function() {
        ...
        ? function(t, e) {
            for (
              var r = C(t), n = arguments.length, o = 1, i = yt.f, s = vt.f;
              n > o;
  ...
  var _t = K('match'),
    gt = function(t, e, r) {
      if (l((n = e)) && (void 0 !== (o = n[_t]) ? o : 'RegExp' == I(n)))
  ...
  var St = c(function(t) {
    ...
    jt = function(t, e, r) {
      t &&
        !j((t = r ? t : t.prototype), At) &&
        Et(t, At, { configurable: !0, value: e })
    },
    Pt = { f: K },
    Tt = O.f,
    kt = function(t) {
      var e = h.Symbol || (h.Symbol = f.Symbol || {})
      '_' == t.charAt(0) || t in e || Tt(e, t, { value: Pt.f(t) })
    },
    xt = y
    ...
    Gt = {
      f: function(t) {
        return zt && '[object Window]' == Mt.call(t)
          ? (function(t) {
              try {
                return Ut(t)
              } catch (t) {
    ...
    he = function(t, e, r) {
      return (
        ...
        j(re, e)
          ? (r.enumerable
              ? (j(t, Qt) && t[Qt][e] && (t[Qt][e] = !1),
                (r = Rt(r, { enumerable: S(0, !1) })))
              : (j(t, Qt) || Kt(t, Qt, S(1, {})), (t[Qt][e] = !0)),
            ue(t, e, r))
          : Kt(t, e, r)
      )
    },
        ...
        var r,
          n = (function(t) {
            var e = dt(t),
              r = yt.f
            if (r)
              for (var n, o = r(t), i = vt.f, s = 0; o.length > s; )
    ...
    pe = function(t) {
      ...
      return (
        !(this === oe && j(re, t) && !j(ne, t)) &&
        (!(e || !j(this, t) || !j(re, t) || (j(this, Qt) && this[Qt][t])) || e)
      )
    },
    de = function(t, e) {
      if (((t = it(t)), (e = g(e, !0)), t !== oe || !j(re, e) || j(ne, e))) {
        var r = qt(t, e)
        return (
          !r || !j(re, e) || (j(t, Qt) && t[Qt][e]) || (r.enumerable = !0), r
        )
      }
    },
    ye = function(t) {
    ...
    ve = function(t) {
      for (
        var e, r = t === oe, n = $t(r ? ne : it(t)), o = [], i = 0;
        n.length > i;
  ...
  ie ||
    (x(
      (Jt = function() {
        ...
        var t = k(arguments.length > 0 ? arguments[0] : void 0),
          e = function(r) {
            this === oe && e.call(ne, r),
              j(this, Qt) && j(this[Qt], t) && (this[Qt][t] = !1),
              ue(this, t, S(1, r))
          }
        return y && ae && ue(oe, t, { configurable: !0, set: e }), ce(t)
      }).prototype,
      'toString',
      function() {
        return this._k
    ...
    (vt.f = pe),
    (yt.f = ve),
    y && x(oe, 'propertyIsEnumerable', pe, !0),
    (Pt.f = function(t) {
      return ce(K(t))
    })),
    N(N.G + N.W + N.F * !ie, { Symbol: Jt })
  for (
    var be = 'hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables'.split(
        ',',
      ),
      me = 0;
    be.length > me;
  ...
  N(N.S + N.F * !ie, 'Symbol', {
    ...
    keyFor: function(t) {
      ...
      for (var e in ee) if (ee[e] === t) return e
    },
    useSetter: function() {
      ae = !0
    },
    ...
    Jt.prototype[Zt] || E(Jt.prototype, Zt, Jt.prototype.valueOf),
    jt(Jt, 'Symbol'),
    jt(Math, 'Math', !0),
    jt(f.JSON, 'JSON', !0)
  ...
  var je,
    Pe = function(t, e, r) {
      ;(t.prototype = Rt(Ae, { next: S(1, r) })), jt(t, e + ' Iterator')
    },
    Te = ct('IE_PROTO'),
    ke = Object.prototype,
    xe =
    ...
    De = function(t, e, r, n, o, i, s) {
      ...
      if (
        (m &&
          (c = xe(m.call(new t()))) !== Object.prototype &&
          c.next &&
          (jt(c, h, !0), 'function' != typeof c[Fe] && E(c, Fe, Ne)),
        l &&
          y &&
          'values' !== y.name &&
          ((p = !0),
  ...
  De(
    ...
    function() {
      ...
      return r >= e.length
        ? { value: void 0, done: !0 }
        : ((t = Ie(e, r)), (this._i += t.length), { value: t, done: !1 })
    },
  )
  var Re = function(t, e) {
    ...
    Be = De(
      ...
      function() {
        ...
        return !t || r >= t.length
          ? ((this._t = void 0), Re(1))
          : Re(0, 'keys' == e ? r : 'values' == e ? t[r] : [r, t[r]])
      },
      'values',
    )
  ...
  for (
    ...
    if (
      $e &&
      ($e[Ce] || E($e, Ce, Me), $e[Ue] || E($e, Ue, Ve), (Ee[Ve] = Me), qe)
    )
  ...
  var Qe = 'FirebaseError',
    ...
    tr = (function() {
      return function(t, e) {
        if (((this.code = t), (this.message = e), Ze))
          Ze(this, er.prototype.create)
        else
          try {
    ...
    return (
      (t.prototype.create = function(t, e) {
        ...
        ;(r =
          void 0 === n
            ? 'Error'
            : n.replace(this.pattern, function(t, r) {
                var n = e[r]
    ...
    ;(function(t, e) {
      ...
      (e.prototype.compress_ = function(t, e) {
        ...
        for (n = 0; n < 80; n++) {
          n < 40
            ? n < 20
              ? ((i = f ^ (u & (c ^ f))), (s = 1518500249))
              : ((i = u ^ c ^ f), (s = 1859775393))
            : n < 60
              ? ((i = (u & c) | (f & (u | c))), (s = 2400959708))
              : ((i = u ^ c ^ f), (s = 3395469782))
      ...
      (e.prototype.update = function(t, e) {
        if (null != t) {
          void 0 === e && (e = t.length)
          for (
            var r = e - this.blockSize, n = 0, o = this.buf_, i = this.inbuf_;
            n < e;
      ...
      (t.prototype.subscribe = function(t, e, r) {
        ...
        void 0 ===
          (n = (function(t, e) {
            ...
            ? t
            : { next: t, error: e, complete: r }).next && (n.next = or),
          void 0 === n.error && (n.error = or),
          void 0 === n.complete && (n.complete = or)
      ...
      return (
        ...
        (t.prototype.delete = function() {
          ...
          return new Promise(function(e) {
            ...
            .then(function() {
              ...
              var e = []
              return (
                Object.keys(t.services_).forEach(function(r) {
        ...
        (t.prototype._getService = function(t, e) {
          if (
            ...
            var r = e !== sr ? e : void 0,
              n = this.firebase_.INTERNAL.factories[t](
                this,
        ...
        (t.prototype.checkDestroyed_ = function() {
          this.isDeleted_ && cr('app-deleted', { name: this.name_ })
        }),
        t
      )
    })()
  ...
  ;(ur.prototype.name && ur.prototype.options) ||
    ur.prototype.delete ||
    console.log('dc')
  ...
  return (function t() {
    var e = {},
      ...
      o = {
        ...
        initializeApp: function(t, r) {
          ...
          var s = i.name
          ;('string' == typeof s && s) || cr('bad-app-name', { name: s + '' }),
            ir(e, s) && cr('duplicate-app', { name: s })
          var u = new ur(t, i, o)
        ...
        INTERNAL: {
          registerService: function(t, e, a, u, c) {
            r[t] && cr('duplicate-service', { name: t }),
              (r[t] = e),
              u &&
                ((n[t] = u),
            ...
            var f = function(e) {
              return (
                void 0 === e && (e = i()),
                'function' != typeof e[t] &&
                  cr('invalid-app-argument', { name: t }),
                e[t]()
              )
            }
            return (
    ...
    function i(t) {
      return ir(e, (t = t || sr)) || cr('no-app', { name: t }), e[t]
    }
    function s() {
    ...
    return (
      Xe(o, 'default', o),
      Object.defineProperty(o, 'apps', { get: s }),
      Xe(i, 'App', ur),
      o
    )
  })()
