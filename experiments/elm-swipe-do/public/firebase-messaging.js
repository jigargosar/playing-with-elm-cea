try {
  !(function(e, t) {
    ...
    var a = 'FirebaseError',
      ...
      u = (function() {
        return function(e, t) {
          if (((this.code = e), (this.message = t), c))
            c(this, h.prototype.create)
          else
            try {
      ...
      r(t, e),
        ...
        (t.prototype.compress_ = function(e, t) {
          ...
          for (r = 0; r < 80; r++) {
            r < 40
              ? r < 20
                ? ((o = h ^ (c & (u ^ h))), (s = 1518500249))
                : ((o = c ^ u ^ h), (s = 1859775393))
              : r < 60
                ? ((o = (c & u) | (h & (c | u))), (s = 2400959708))
                : ((o = c ^ u ^ h), (s = 3395469782))
        ...
        (t.prototype.update = function(e, t) {
          if (null != e) {
            void 0 === t && (t = e.length)
            for (
              var n = t - this.blockSize, r = 0, i = this.buf_, o = this.inbuf_;
              r < t;
    ...
    var l,
      ...
      v = (((l = {})[b.AVAILABLE_IN_WINDOW] =
        'This method is available in a Window context.'),
      (l[b.AVAILABLE_IN_SW] =
        'This method is available in a service worker context.'),
      (l[b.SHOULD_BE_INHERITED] =
      ...
      (l[b.FAILED_DELETE_VAPID_KEY] = 'The VAPID key could not be deleted.'),
      (l[b.INVALID_PUBLIC_VAPID_KEY] =
        'The public VAPID key must be a string.'),
      (l[b.PUBLIC_KEY_DECRYPTION_FAILED] =
    ...
    function y(e, t) {
      ...
      for (
        var n = new DataView(e), r = new DataView(t), i = 0;
        i < e.byteLength;
        i++
      )
    ...
    var I = (function() {
      function e() {}
      return (
        (e.prototype.getToken = function(e, t, n) {
                ...
                case 0:
                  ;(r = w(t.getKey('p256dh'))),
                    ...
                    (o =
                      ...
                      i),
                    y(n.buffer, T.buffer) ||
                      ((a = w(n)), (o += '&application_pub_key=' + a)),
                    (c = new Headers()).append(
                      'Content-Type',
                      'application/x-www-form-urlencoded',
                    ),
                    (u = { method: 'POST', headers: c, body: o }),
                    (s.label = 1)
                case 1:
                  return (
                    s.trys.push([1, 4, , 5]),
                    [4, fetch(S + '/fcm/connect/subscribe', u)]
                  )
                case 2:
              ...
              switch (s.label) {
                case 0:
                  ;(o = w(r.getKey('p256dh'))),
                    ...
                    (c =
                      ...
                      a),
                    y(i.buffer, T.buffer) ||
                      ((u = w(i)), (c += '&application_pub_key=' + u)),
                    (h = new Headers()).append(
                      'Content-Type',
                      'application/x-www-form-urlencoded',
                    ),
                    (f = { method: 'POST', headers: h, body: c }),
                    (s.label = 1)
                case 1:
                  return (
                    s.trys.push([1, 4, , 5]),
                    [4, fetch(S + '/fcm/connect/subscribe', f)]
                  )
                case 2:
                  return [4, s.sent().json()]
                case 3:
                ...
                case 5:
                  if (d.error)
                    ...
                    g.create(b.TOKEN_UPDATE_FAILED, { message: p }))
          ...
          return o(this, void 0, void 0, function() {
            ...
            return s(this, function(s) {
              switch (s.label) {
                case 0:
                  ;(r =
                    'authorized_entity=' + e + '&token=' + t + '&pushSet=' + n),
                ...
                case 1:
                  return (
                    s.trys.push([1, 4, , 5]),
                    [4, fetch(S + '/fcm/connect/unsubscribe', o)]
                  )
                case 2:
                  return [4, s.sent().json()]
                case 3:
                  if ((a = s.sent()).error)
                    ...
                    g.create(b.TOKEN_UNSUBSCRIBE_FAILED, { message: c }))
                  return [3, 5]
                case 4:
    ...
    var k = (function() {
      ...
      return (
        ...
        (e.prototype.getDb = function() {
          ...
          return (
            this.dbPromise ||
              (this.dbPromise = new Promise(function(t, n) {
                ...
                if (e) {
                  ...
                  t.createTime || (n.createTime = Date.now()),
                    'string' == typeof t.vapidKey &&
                      (n.vapidKey = D(t.vapidKey)),
                    'string' == typeof t.auth && (n.auth = D(t.auth).buffer),
                    'string' == typeof t.auth &&
                      (n.p256dh = D(t.p256dh).buffer),
                    e.update(n),
                    e.continue()
                }
              }
        ...
        (t.prototype.getTokenDetailsFromToken = function(e) {
          return o(this, void 0, void 0, function() {
            return s(this, function(t) {
              ...
              return P({ fcmToken: e }), [2, this.getIndex('fcmToken', e)]
            })
          })
        }),
        (t.prototype.getTokenDetailsFromSWScope = function(e) {
          return o(this, void 0, void 0, function() {
            return s(this, function(t) {
              ...
              return P({ swScope: e }), [2, this.get(e)]
            })
          })
        }),
          ...
          return o(this, void 0, void 0, function() {
            return s(this, function(t) {
              ...
              if (!e.endpoint || !e.auth || !e.p256dh)
                throw g.create(b.BAD_SUBSCRIPTION)
              ...
              switch (n.label) {
                case 0:
                  return 'string' != typeof e || 0 === e.length
                    ? [2, Promise.reject(g.create(b.INVALID_DELETE_TOKEN))]
                    : [4, this.getTokenDetailsFromToken(e)]
                case 1:
    ...
    function P(e) {
      ...
      if (
        ...
        throw g.create(b.BAD_SENDER_ID)
      if (
        e.fcmPushSet &&
        ('string' != typeof e.fcmPushSet || 0 === e.fcmPushSet.length)
      )
        throw g.create(b.BAD_PUSH_SET)
    }
    var C = (function(e) {
        function t() {
          var t = (null !== e && e.apply(this, arguments)) || this
          return (
            (t.dbName = 'fcm_vapid_details_db'),
            (t.dbVersion = 1),
            ...
            return o(this, void 0, void 0, function() {
              ...
              return s(this, function(r) {
                ...
                if (null === t || 65 !== t.length)
                  throw g.create(b.BAD_VAPID_KEY)
                return (n = { swScope: e, vapidKey: t }), [2, this.put(n)]
              })
            })
          }),
            ...
            return o(this, void 0, void 0, function() {
              ...
              return s(this, function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    if (!(t = n.sent()))
                      throw g.create(b.DELETE_SCOPE_NOT_FOUND)
      ...
      R = (function() {
        function e(e) {
          var t = this
          if (!e.options[B] || 'string' != typeof e.options[B])
            throw g.create(b.BAD_SENDER_ID)
          ;(this.messagingSenderId = e.options[B]),
            (this.tokenDetailsModel = new A()),
            (this.vapidDetailsModel = new C()),
            (this.iidModel = new I()),
            (this.app = e),
            (this.INTERNAL = {
              delete: function() {
                ...
                switch (o.label) {
                  case 0:
                    if ('denied' === (e = this.getNotificationPermission_()))
                      throw g.create(b.NOTIFICATIONS_BLOCKED)
                    return 'granted' !== e
                      ? [2, null]
                  ...
                  case 4:
                    return (i = o.sent())
                      ? [2, this.manageExistingToken(t, r, n, i)]
                      : [2, this.getNewToken(t, r, n)]
                }
              })
            })
          }),
                ...
                switch (i.label) {
                  case 0:
                    return (function(e, t, n) {
                      if (!n.vapidKey || !y(t.buffer, n.vapidKey.buffer))
                        return !1
              ...
              return s(this, function(o) {
                switch (o.label) {
                  case 0:
                    return [
                      4,
                      this.iidModel.getToken(this.messagingSenderId, t, n),
                    ]
                  case 1:
                    return (
                      (r = o.sent()),
      ...
      return (
          ...
          return o(this, void 0, void 0, function() {
            ...
            return s(this, function(i) {
              switch (i.label) {
                ...
                case 2:
                  throw ((t = i.sent()),
                  g.create(b.UNABLE_TO_RESUBSCRIBE, { message: t }))
                case 3:
                  return (
                    i.trys.push([3, 5, , 8]),
        ...
        (t.prototype.setBackgroundMessageHandler = function(e) {
          if (!e || 'function' != typeof e)
            throw g.create(b.BG_HANDLER_FUNCTION_EXPECTED)
          ...
          return o(this, void 0, void 0, function() {
            ...
            return s(this, function(n) {
              switch (n.label) {
                ...
                case 1:
                  if (!(e = n.sent()))
                    throw g.create(b.SW_REGISTRATION_EXPECTED)
                  return [
                    4,
      ...
      F = (function(e) {
        function t(t) {
          ...
          return (
            ...
            (n.onMessageInternal = f(function(e) {
              n.messageObserver = e
            })),
        ...
        return (
                          ...
                          return o(this, void 0, void 0, function() {
                            ...
                            return s(this, function(n) {
                              switch (n.label) {
                                ...
                                case 1:
                                  return (
                                    n.trys.push([1, 4, , 5]), [4, fetch(e.href)]
                                  )
                                case 2:
                                ...
                                case 5:
                                  ...
                                  if ('103953800507' !== t.gcm_sender_id)
                                    throw g.create(b.INCORRECT_GCM_SENDER_ID)
                                  return [2]
                              }
                            })
                          })
              ...
              return s(this, function(t) {
                switch (t.label) {
                  ...
                  case 1:
                    ...
                    throw 'denied' === e
                      ? g.create(b.PERMISSION_BLOCKED)
                      : g.create(b.PERMISSION_DEFAULT)
                }
              })
            })
          }),
          (t.prototype.useServiceWorker = function(e) {
            ...
            if (null != this.registrationToUse)
              throw g.create(b.USE_SW_BEFORE_GET_TOKEN)
          ...
          (t.prototype.usePublicVapidKey = function(e) {
            ...
            if (null != this.publicVapidKeyToUse)
              throw g.create(b.USE_PUBLIC_KEY_BEFORE_GET_TOKEN)
            var t = D(e)
    ...
    ;(M = { isSupported: W }),
      t.INTERNAL.registerService(
        'messaging',
        function(e) {
          if (!W()) throw g.create(b.UNSUPPORTED_BROWSER)
          return self && 'ServiceWorkerGlobalScope' in self
            ? new U(e)
            : new F(e)
        },
