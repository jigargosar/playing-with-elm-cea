try {
  !(function(e, t) {
          ...
          return r(this, void 0, void 0, function() {
            ...
            return o(this, function(t) {
              switch (t.label) {
                case 0:
                  return (
                    t.trys.push([0, 2, , 3]), [4, this.app.INTERNAL.getToken()]
                  )
                case 1:
          ...
          return r(this, void 0, void 0, function() {
            ...
            return o(this, function(n) {
              switch (n.label) {
                ...
                case 2:
                  return (
                    (t = n.sent()), [2, { authToken: e, instanceIdToken: t }]
                  )
              }
            })
          })
    ...
    var c,
      ...
      f = (function() {
        function e(e, t) {
          void 0 === t && (t = 'us-central1'),
            (this.app_ = e),
            (this.region_ = t),
            (this.serializer = new l()),
            (this.emulatorOrigin = null),
            (this.contextProvider = new s(e))
        }
        return (
          ...
          (e.prototype.httpsCallable = function(e) {
            var t = this
            return function(n) {
              return t.call(e, n)
            }
              ...
              return o(this, function(o) {
                switch (o.label) {
                  ...
                  case 1:
                    return (
                      (u = o.sent()).authToken &&
                        s.append('Authorization', 'Bearer ' + u.authToken),
                      u.instanceIdToken &&
                        s.append(
                          'Firebase-Instance-ID-Token',
                          u.instanceIdToken,
                        ),
                      [4, this.postJSON(n, r, s)]
                    )
                  case 2:
                    if (
                      ((c = o.sent()),
                      (l = (function(e, t, n) {
                        ...
                        try {
                          ...
                          if (u) {
                            var c = u.status
                            if ('string' == typeof c) {
                              if (!i[c]) return new a('internal', 'internal')
                              r = i[c]
                            }
                            o = c
                            var l = u.message
                            'string' == typeof l && (o = l),
                              void 0 !== (s = u.details) && (s = n.decode(s))
                          }
                        } catch (e) {}
                        return 'ok' === r ? null : new a(r, o, s)
                      })(c.status, c.json, this.serializer)))
                    )
                      throw l
                    if (!c.json)
                      throw new a(
                    ...
                    if (
                      (void 0 === (f = c.json.data) && (f = c.json.result),
                      void 0 === f)
                    )
                      throw new a('internal', 'Response is missing data field.')
                    return [2, { data: this.serializer.decode(f) }]
                }
              })
            })
          }),
    ...
    ;(c = { Functions: f }), t.INTERNAL.registerService(p, d, c, void 0, !0)
